...
# from modules.users.database.models.User import User, UserSchema
...
#     type_id = db.Column(
#         db.Integer,
#         db.ForeignKey("datasource_types.id", onupdate="CASCADE", ondelete="SET NULL"),
#         nullable=False,
#     )
#     type = db.relationship("DatasourceTypeModel")
#     context_id = db.Column(
#         db.Integer,
#         db.ForeignKey("contexts.id", onupdate="CASCADE", ondelete="CASCADE"),
#         nullable=False,
#     )
#     context = db.relationship(
#         "ContextModel", backref=backref("datasources", passive_deletes=True)
#     )
...
#     contextMap = maFields.List(
#         maFields.Nested("DatasourceContextMapModelSchema", exclude=("datasource",))
#     )
...
#     datasources = maFields.List(
#         maFields.Nested("DatasourceModelSchema", exclude=("context",))
#     )
#     created_at = maFields.DateTime()
#     updated_at = maFields.DateTime()
...
#         "ContextModel",
#         backref=backref(
#             "fields", passive_deletes=True, order_by="ContextFieldModel.id.asc()"
#         ),
#     )
...
#     driver_id = db.Column(
#         db.Integer,
#         db.ForeignKey("jdbc_drivers.id", onupdate="CASCADE", ondelete="SET NULL"),
#         nullable=False,
#     )
#     driver = db.relationship("JDBCDriverModel")
#     datasource_id = db.Column(
#         db.Integer,
#         db.ForeignKey("datasources.id", onupdate="CASCADE", ondelete="CASCADE"),
#         nullable=False,
#     )
#     datasource = db.relationship(
#         "DatasourceModel",
#         backref=backref("database", uselist=False, passive_deletes=True),
#     )
...
#     )
#     datasource = db.relationship(
#         "DatasourceModel", viewonly=True, backref=backref("contextMap")
#     )
